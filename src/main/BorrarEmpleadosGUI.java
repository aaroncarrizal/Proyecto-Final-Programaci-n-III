 ...
 * @author aaron
 */
public class BorrarEmpleadosGUI extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BorrarEmpleadosGUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
